        ...
        internalStoragePhotoAdapter = InternalStoragePhotoAdapter{
            lifecycleScope.launch {
                ...
                if (isDeleted) {
                    ...
                    Toast.makeText(this@CameraActivity, "Photo Deleted", Toast.LENGTH_SHORT)
                        .show()
                } else {
                    Toast.makeText(this@CameraActivity, "Deletion Failed", Toast.LENGTH_SHORT).show()
                }
            }
        }
...
//        ------intent-Launcher---------
        ...
        intentLauncher = registerForActivityResult(ActivityResultContracts.StartIntentSenderForResult()){
            if(it.resultCode == RESULT_OK){
                Toast.makeText(this@CameraActivity, "Photo Deleted", Toast.LENGTH_SHORT).show()
            }
            else{
                Toast.makeText(this@CameraActivity, "Deletion Failed", Toast.LENGTH_SHORT).show()
            }
        ...
        val takePhoto = registerForActivityResult(ActivityResultContracts.TakePicturePreview()){
            lifecycleScope.launch{
                ...
                val isSaveSuccess = when{
                    ...
                    if (isSaveSuccess) {
                        Toast.makeText(this@CameraActivity, "Saving Successful", Toast.LENGTH_SHORT).show()
                    } else {
                        Toast.makeText(this@CameraActivity, "Saving Failed", Toast.LENGTH_SHORT).show()
                    }
            }
        }
...
//            use glide to load images into recyclerView
